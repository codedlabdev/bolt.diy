...
Check if Node.js appears in the "Path" variable
For Mac/Linux Users:
Open Terminal
Type this command:
echo $PATH
...
Click the settings icon in the sidebar to open the settings menu Settings Button Location

Navigate to the "Providers" tab

Search for your provider using the search bar

Enter your custom base URL in the designated field Provider Base URL Configuration
